...
OTHER_FILES += \
    ...
    android-source/src/org/qtproject/example/hangman/ExternalReceiver.java \
    #android-source/src/org/qtproject/example/hangman/MainActivity.java \
    android-source/src/org/qtproject/example/hangman/MessageReceivingService.java \
